...
const filePath = path.join(__dirname, '..', 'public', 'data', 'הלכות הנהגת אדם בבוקר', 'siman_1_knowledge.json');

const rawData = fs.readFileSync(filePath, 'utf8');
const data = JSON.parse(rawData);

// Les 6 leçons et leurs 3 notions
const lessons = [
  {
    sources: [1, 8, 9],
    notions: [
  ...
  },
  {
    ...
    notions: [
      ...
      },
      {
        ...
        quizPrompt: "\"La vraie Zrizout (motivation spirituelle), c'est de s'organiser pour faire les choses avec calme et à l'heure, et non de courir partout en étant en retard.\"",
        quizOptions: [
          "Vrai",
          "Faux"
        ],
    ...
    notions: [
      ...
      },
      {
        ...
        quizOptions: [
          ...
          "Pour rester humble et ne pas chercher à se vanter devant les autres."
        ],
        quizAnswer: "Pour rester humble et ne pas chercher à se vanter devant les autres."
      },
      {
        ...
        quizEyebrow: "Vrai ou Faux ?",
        quizPrompt: "\"Si quelqu'un critique ma religion, je dois lui crier dessus et chercher le conflit pour me faire respecter.\"",
        quizOptions: [
          "Vrai",
          "Faux (On reste fier de nos valeurs, mais on évite les querelles !)."
        ],
        quizAnswer: "Faux (On reste fier de nos valeurs, mais on évite les querelles !)."
      }
    ]
  },
  {
    ...
    notions: [
      ...
      },
      {
        ...
        quizEyebrow: "Vrai ou Faux ?",
        quizPrompt: "\"Prendre un instant pour penser à l'amour de Dieu juste avant de prier m'aide à ne pas lire les mots mécaniquement, comme un robot.\"",
        quizOptions: [
          "Vrai",
          "Faux"
        ],
...
for (const lesson of lessons) {
  // Convertir le tableau de sources en un tableau d'objets pour le JSON
  const mappedSources = lesson.sources.map(s => ({ siman: 1, seif: s }));
...
console.log("siman_1_knowledge.json mis à jour !");
